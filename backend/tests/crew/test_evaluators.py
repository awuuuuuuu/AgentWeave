"""evaluators.py 单元测试 — crew_unit，无外部依赖。"""
...
class TestCheckDeptKeywords:
    def test_matching_keyword_passes(self):
        from tests.crew.evaluators import check_dept_keywords
...
class TestCheckMcpWhitelist:
    def test_required_tool_present_passes(self):
        from tests.crew.evaluators import RESEARCH_MCP_WHITELIST, check_mcp_whitelist
    ...
    def test_dept_with_no_required_tools_passes(self):
        from tests.crew.evaluators import EXECUTION_MCP_WHITELIST, check_mcp_whitelist
...
class TestCheckMapEventCoordinates:
    def test_valid_coordinates_passes(self):
        from tests.crew.evaluators import check_map_event_coordinates
...
class TestCheckKeyFactsHaveNumbers:
    def test_fact_with_number_passes(self):
        from tests.crew.evaluators import check_key_facts_have_numbers
...
class TestCheckPlanSteps:
    ...
    def test_valid_plan_returns_no_errors(self):
        from tests.crew.evaluators import check_plan_steps
        steps = [
